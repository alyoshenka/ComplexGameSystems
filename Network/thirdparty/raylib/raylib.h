...
typedef struct CharInfo {
    ...
    RayRectangle rec;          // Character rectangle in sprite font
...
RLAPI void ImageDraw(Image *dst, Image src, RayRectangle srcRec, RayRectangle dstRec);                         // Draw a source image within a destination image
